...
export const DEFAULT_SITE_DATA = {
  ...
  stats: [
    ...
    { id: 3, value: 3, suffix: "+", label: "Years of Excellence" },
  ...
  teachers: [
    {
      id: 1, name: 'ლანა ჩხარტიშვილი', title: 'Founder & Academic Director',
      avatar: 'ლჩ', color: 'bg-blue-700',
      ...
      bio: 'ლანა ჩხარტიშვილი founded Kutaisi English Academy with a vision to bring world-class English education to Georgia. Holder of the prestigious DELTA qualification, she has guided hundreds of students to achieve their language goals.',
  ...
  testimonials: [
    { id: 1, avatar: "MK", color: "bg-blue-600", rating: 5, name: "Mariam Kvaratskhelia", role: "University Student", location: "Kutaisi", text: "After just 6 months at Kutaisi English Academy, I passed my IELTS with a 7.5 score. The teachers are incredibly patient and the small class sizes meant I could ask questions freely. I honestly couldn't have done it without them.", photoUrl: '' },
    { id: 2, avatar: "GT", color: "bg-purple-600", rating: 5, name: "Giorgi Tsikarishvili", role: "Software Engineer", location: "Kutaisi", text: "I needed Business English for my remote job with a UK company. The Business English course gave me confidence in meetings and writing professional emails. My manager noticed the improvement within weeks.", photoUrl: '' },
    { id: 3, avatar: "AB", color: "bg-emerald-600", rating: 5, name: "Ana Beridze", role: "High School Student", location: "Kutaisi", text: "I started from absolute zero and now I can have full conversations in English. The teachers make learning fun and engaging. The academy feels like a family — everyone supports each other.", photoUrl: '' },
    { id: 4, avatar: "LG", color: "bg-amber-600", rating: 5, name: "Luka Gelashvili", role: "Marketing Manager", location: "Kutaisi", text: "I had taken English courses before, but nothing like this. The methodology here is completely different — practical, modern, and results-oriented. I can now lead international client calls confidently.", photoUrl: '' },
    { id: 5, avatar: "NS", color: "bg-rose-600", rating: 5, name: "Nino Shalamberidze", role: "Medical Professional", location: "Kutaisi", text: "As a doctor needing English for international conferences and research papers, the Advanced course was exactly what I needed. The academic writing component was invaluable for my career.", photoUrl: '' },
  ],
  benefits: [
  ...
  pages: {
    about: {
      hero: { eyebrow: "About the Academy", title: "Trusted English Education in the Heart of", highlight: "Kutaisi", subtitle: "For over three years we have been Kutaisi's leading destination for professional English language education — from complete beginners to advanced speakers." },
      story: { eyebrow: "Our Story", title: "Three years of shaping", titleHighlight: "English fluency in Georgia", p1: "Founded in 2022 by ლანა ჩხარტიშვილი, Kutaisi English Academy was born from a simple but powerful belief: every student in Kutaisi deserves access to world-class English education. What started as a small classroom has grown into the city's most trusted language institution.", p2: "Today we offer four CEFR-aligned programmes, taught by 15+ CELTA/DELTA-certified educators, with a 96% student satisfaction rate and over 1,200 graduates who have transformed their careers, studies, and lives through English.", badges: ["CEFR Aligned", "15+ Teachers", "96% Satisfaction", "3+ Years"] },
    ...
    testimonials: {
      ...
      stats: [{ value: "4.9 / 5", label: "Average Rating", stars: true }, { value: "96%", label: "Student Satisfaction" }, { value: "1,200+", label: "Total Students" }, { value: "3+ Years", label: "Trusted Since 2022" }],
  ...
  blogs: [
    {
      ...
      category: "Tips",
      coverImage: "https://images.unsplash.com/photo-1543269664-56d93c1b41a6?auto=format&fit=crop&w=800&q=80",
    ...
    {
      id: "4",
      title: "10 Essential Vocabulary Strategies for Rapid English Learning",
      slug: "vocabulary-strategies-rapid-english-learning",
      excerpt: "Expanding your English vocabulary doesn't have to be boring. These 10 research-backed strategies will help you learn and retain new words faster than ever.",
      content: "<p>Vocabulary is the foundation of any language. The more words you know, the more confidently you can express yourself. Here are 10 strategies our students use to supercharge their vocabulary growth.</p><h2>1. Use Spaced Repetition</h2><p>Apps like Anki use algorithms to show you words just before you forget them, making learning far more efficient than traditional flashcards.</p><h2>2. Learn Words in Context</h2><p>Instead of memorizing isolated words, learn them in full sentences. Context gives words meaning and makes them easier to remember.</p><h2>3. Group Words by Topic</h2><p>Learn vocabulary sets around themes: food, travel, work. This creates mental connections that strengthen retention.</p><h2>4. Use New Words the Same Day</h2><p>Every time you learn a new word, use it in a sentence, in a conversation, or in writing before the day is over.</p><h2>5. Read Widely</h2><p>News articles, novels, and blogs expose you to vocabulary in authentic contexts. Aim for 20 minutes of English reading per day.</p>",
      category: "Vocabulary",
      coverImage: "https://images.unsplash.com/photo-1481627834876-b7833e8f5570?auto=format&fit=crop&w=800&q=80",
      author: "Nino Chikvanaia",
      authorRole: "Senior English Teacher",
    ...
    {
      id: "5",
      title: "How to Master English Listening Skills at Home",
      slug: "master-english-listening-skills-home",
      excerpt: "You don't need to travel abroad to develop excellent English listening comprehension. Here's how to train your ear using resources you already have.",
      content: "<p>Listening is often the hardest skill to develop in a foreign language — especially when speakers talk fast, use slang, or have strong accents. But with the right approach, you can train your ear at home.</p><h2>Active vs. Passive Listening</h2><p>Passive listening (background music or TV) helps with general exposure. Active listening — where you focus intently, take notes, and replay sections — is what builds real comprehension.</p><h2>Podcasts and Audiobooks</h2><p>Start with podcasts designed for English learners, then gradually move to native-speaker content. BBC Learning English and VOA Learning English are great starting points.</p><h2>Watch TV With Subtitles</h2><p>Begin with English subtitles, not your native language. This forces your brain to connect the spoken word with its written form rather than translating.</p><h2>Dictation Practice</h2><p>Play a short audio clip and write down exactly what you hear. This is one of the most effective active listening exercises available.</p>",
      category: "Tips",
      coverImage: "https://images.unsplash.com/photo-1590602847861-f357a9332bbc?auto=format&fit=crop&w=800&q=80",
      author: "Tamar Kvaratskhelia",
      authorRole: "Foundation & Young Adult Teacher",
    ...
    {
      id: "6",
      title: "Common English Grammar Mistakes Georgians Make — and How to Fix Them",
      slug: "common-grammar-mistakes-georgians-how-to-fix",
      excerpt: "Georgian and English are structurally very different languages. These are the grammar mistakes we see most often from our students — and exactly how to correct them.",
      content: "<p>Every native language creates a unique set of challenges when learning English. For Georgian speakers, several structural differences cause recurring errors. Here are the most common and how to overcome them.</p><h2>1. Omitting the Article (a, an, the)</h2><p>Georgian has no articles, so many students write 'I went to school' when they mean 'I went to the school.' Learning when to use definite vs. indefinite articles takes deliberate practice.</p><h2>2. Incorrect Verb Tense Sequencing</h2><p>English has more tenses than Georgian, and the present perfect is especially tricky. 'I already did it' should often be 'I have already done it.'</p><h2>3. Word Order in Questions</h2><p>Georgian is flexible with word order; English is not. 'You are going where?' is incorrect — it must be 'Where are you going?'</p><h2>4. Overusing the Continuous Tense</h2><p>Students sometimes say 'I am knowing the answer' instead of 'I know the answer.' State verbs like know, believe, and understand don't use continuous forms.</p>",
      category: "Grammar",
      ...
      authorRole: "English Teacher & Methodology Coach",
